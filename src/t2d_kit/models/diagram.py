        ...
        framework_capabilities = {
            FrameworkType.D2: {
                'types': {
                    ...
                    DiagramType.C4_COMPONENT, DiagramType.ARCHITECTURE,
            ...
            FrameworkType.MERMAID: {
                'types': {
                    DiagramType.SEQUENCE, DiagramType.FLOWCHART, DiagramType.ERD,
                    DiagramType.GANTT, DiagramType.STATE, DiagramType.CLASS,
                    DiagramType.PIE, DiagramType.JOURNEY, DiagramType.QUADRANT,
            ...
            FrameworkType.PLANTUML: {
                'types': {
                    ...
                    DiagramType.PLANTUML_WIREFRAME, DiagramType.PLANTUML_NETWORK
                },
                'formats': {OutputFormat.SVG, OutputFormat.PNG, OutputFormat.PDF}
            }
        }
