...
class TestD2GenerationIntegration:
    ...
    def test_generate_svg_output(self, mock_subprocess):
        ...
        diagram_spec = DiagramSpec(d2_content=d2_content, title="Simple Diagram")
    ...
    def test_generate_png_output(self, mock_subprocess):
        ...
        diagram_spec = DiagramSpec(d2_content=d2_content, title="Frontend Backend Diagram")
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            # Generate PNG
            generator.generate_png(d2_path, png_path)
    ...
    def test_generate_with_layout_options(self):
        ...
        diagram_spec = DiagramSpec(d2_content=d2_content, title="Layout Test Diagram")
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            layout_options = {"layout": "elk", "theme": "dark", "sketch": True}

            result_path = generator.generate(
                diagram_spec, output_path, layout_options=layout_options
            )
    ...
    def test_d2_command_error_handling(self, mock_subprocess):
        ...
        diagram_spec = DiagramSpec(d2_content=d2_content, title="Invalid Diagram")
    ...
    def test_generate_with_custom_styling(self):
        ...
        diagram_spec = DiagramSpec(d2_content=d2_content, title="Styled Diagram")
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            result_path = generator.generate(
                diagram_spec, output_path, styling_options=styling_options
            )
    ...
    def test_batch_generation(self):
        ...
        for i in range(3):
            ...
            diagram = DiagramSpec(d2_content=d2_content, title=f"Batch Diagram {i+1}")
    ...
    def test_d2_validation_before_generation(self):
        ...
        valid_spec = DiagramSpec(d2_content=valid_d2, title="Valid Diagram")

        # Invalid D2 content
        invalid_d2 = "a -> -> b: invalid syntax"
        invalid_spec = DiagramSpec(d2_content=invalid_d2, title="Invalid Diagram")
    ...
    def test_output_format_options(self, mock_subprocess):
        ...
        diagram_spec = DiagramSpec(d2_content=d2_content, title="Format Test")
