...
**Purpose**: Individual diagram definition with framework routing
**Source**: Parsed from Recipe or generated by routing agent
...
| title | string | Yes | Max 255 chars | Diagram title |
| instructions | string | Yes | Max 50KB | Framework-specific instructions |
| source_format | SourceFormat | Yes | Enum | Output format (d2, mermaid, puml) |
...
This ensures that when content agents run, they have:
- Complete list of available diagrams
- File paths to generated SVG/PNG files
- Diagram titles and descriptions for proper captioning
- Information about diagram types to place them appropriately
